...
define([
  ...
  WaveformZoomView.prototype._resampleData = function(options) {
    ...
    // const pixelLength = output_data.length / channel_count

    this._scale = options.scale;
    this._pixelLength = 16000; // todo: read this from the zoomview
  };
  ...
  WaveformZoomView.prototype.timeToPixels = function(time) {
    return Math.floor(time * this._data.sample_rate / this._scale);
  };
  ...
  WaveformZoomView.prototype.pixelsToTime = function(pixels) {
    return pixels * this._scale / this._data.sample_rate;
  };
